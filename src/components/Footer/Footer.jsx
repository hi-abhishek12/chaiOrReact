...
function Footer() {
  return (
    <section className="relative overflow-hidden py-12 bg-gray-900 text-gray-300 border-t border-gray-800">
        ...
        <div className="flex flex-wrap -mx-6">
          ...
          <div className="w-full p-6 md:w-1/2 lg:w-2/12">
            <div className="h-full">
              <h3 className="mb-6 text-sm font-semibold uppercase tracking-wide text-gray-400">Company</h3>
          ...
          <div className="w-full p-6 md:w-1/2 lg:w-2/12">
            <div className="h-full">
              <h3 className="mb-6 text-sm font-semibold uppercase tracking-wide text-gray-400">Support</h3>
              <ul className="space-y-3">
          ...
          <div className="w-full p-6 md:w-1/2 lg:w-3/12">
            <div className="h-full">
              <h3 className="mb-6 text-sm font-semibold uppercase tracking-wide text-gray-400">Legals</h3>
              <ul className="space-y-3">
